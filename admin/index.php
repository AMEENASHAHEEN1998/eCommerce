<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $stmt = $con->prepare("SELECT UserId, UserName,Password FROM shops.users WHERE UserName = ? AND Password = ? AND GroupId = 1  LIMIT 1");// AND GroupId = 1  هاد لو بدي بس الأعضاء الرئيسين هم الي يقدرو يفوتو
